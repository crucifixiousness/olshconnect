...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const setClause = `approval_status = 'pending', registrar_approved_by = NULL, registrar_approved_at = NULL, dean_approved_by = NULL, dean_approved_at = NULL, final_approved_at = NULL`;
